export const ACCOUNT_REGISTRATION = false;
...
export const ALLOW_UNAUTHENTICATED = true;
...
export const LANGUAGE = process.env.LANGUAGE?.toLowerCase() || "fr";
...
export const UNAUTHENTICATED_USER_SHARING = true;
